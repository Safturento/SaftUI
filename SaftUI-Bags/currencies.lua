...
function INV.CreateCurrencySlot(category)
    ...
    st:SetBackdrop(slot.filterCheckbox, 'none')
    slot.filterCheckbox:Hide()
    slot.filterCheckbox:SetAllPoints(slot)
    slot.filterCheckbox:GetCheckedTexture():SetVertexColor(0, 0, 0, .6)
    INV:HookScript(slot.filterCheckbox, 'OnEnter', function() INV:ShowCurrencyTooltip(slot) end)
    INV:HookScript(slot.filterCheckbox, 'OnLeave', 'HideCurrencyTooltip')
